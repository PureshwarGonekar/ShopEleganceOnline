    ...
    <footer className = "footer py-5 bg-dark">
        <div className = "container">
            <div className = "footer-content text-white grid">
                ...
                <div className = "footer-item text-center">
                    <h6 className='fs-17 fw-6'>About ShopElegance Online</h6>
                    <ul>
                ...
                <div className = "footer-item text-center">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <span className = "fs-15">info@shopeleganceonline.com</span>
                        </li>
                    </ul>
                </div>
            </div>
        </div>
        <p className='text-center credit'>"Innovation brought to life by yours truly <strong className='dev'><a href="https://www.linkedin.com/in/pureshwar-gonekar-358b661aa/">Pureshwar Gonekar</a></strong>, the developer behind the magic." </p>
    </footer>
  )
}
